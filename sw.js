...
const CACHE = 'uncharted-v5';
const SHELL = [
  './', 'index.html', 'css/app.css', 'css/v2.css', 'css/sky.css', 'css/map.css', 'js/hazards.js',
  ...
  'js/stories.js', 'js/place.js', 'js/trips.js', 'js/quests.js', 'js/quiz.js', 'js/sheets.js',
